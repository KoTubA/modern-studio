...
export const HighlightedHeading = ({ width, level = '2', children, isRight = false, ...props }) => {
  ...
  return (
    <StyledHeading playState={playState} ref={headingRef} width={width} isRight={isRight} as={`h${level}`} {...props}>
      {children}
    </StyledHeading>
  );
};
